...
```{r}
pilot_data <- readRDS(here::here("Pilots/Superintendencia_de_Pensiones/data/pilot_data.rds"))
sitios_sm <- readRDS(here::here("Pilots/Superintendencia_de_Pensiones/data/sitios_sm.rds"))
```
...
proporciones %>%
  ...
  ylab("Opt In")
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/prop.pdf"))
```
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/prop_promoter.pdf"))
```
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/prop_asesor.pdf"))
```
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/n_clicks.pdf"))
```
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/responses.pdf"))
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/utility.pdf"))
```
```{r, toomuch}
symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 0.1, 1), 
                   symbols = c("****", "***", "**", "*",".", "ns"))
...
ggplot(aes(y = InfoAbruma2_1, x = as.factor(Treatments), color = Treatments)) +
  ...
  theme(axis.text.x=element_blank(),
        ...
        axis.ticks.x = element_blank()) +
  scale_y_continuous(breaks = seq(0, 10, 2), limits = c(0,12))
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/toomuch.pdf"))
```
...
ggsave(here::here("Pilots/Superintendencia_de_Pensiones/figures/responses_het.pdf"))

 ...
 # right_join(encuestas, by = "useridn") %>%
  ...
  mutate(Age = 2022 - as.numeric(Birth),
         Treatments = factor(case_when(
           sitioderivado== "1" ~ "Perfil",
           sitioderivado== "2" ~ "Video",
           sitioderivado==  "3" ~ "VideoPerfil",
           sitioderivado== "4" ~ "Perfil",
           sitioderivado== "5" ~ "Video",
           sitioderivado== "6" ~ "VideoPerfil",
           sitioderivado== "7" ~ "Baseline",
           sitioderivado== "8" ~ "Baseline"), levels = c("Baseline", "Perfil", "Video", "VideoPerfil")),
         Pension_Type = factor(case_when(
           sitioderivado== "1" ~ "Public",
           sitioderivado== "2" ~ "Public",
           sitioderivado== "3" ~ "Public",
           sitioderivado== "8" ~ "Public",
           sitioderivado== "4" ~ "Private",
           sitioderivado== "5" ~ "Private",
           sitioderivado== "6" ~ "Private",
           sitioderivado== "7" ~ "Private"), levels = c("Public", "Private"))) %>% 
